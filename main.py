...
def graph(function_result: tuple[list[float | int], list[float | int], float | int, list[float | int], list[float | int], list[float | int], list[float | int], list[float | int]],
  ...
  plt.subplot(4, 1, 2)
  #plt.title("f'(x)")
  plt.plot(x, delta1_left, label=f"left; N = {N}")
  plt.plot(x, delta1_right, label=f"right; N = {N}")
  plt.plot(x, delta1_center, label=f"center; N = {N}")
  plt.legend()
  plt.subplot(4, 1, 3)
  #plt.title("f''(x)")
